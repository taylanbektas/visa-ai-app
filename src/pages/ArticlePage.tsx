...
**Uyarı:** Randevu slotları çok hızlı dolmaktadır. Planlamanızı buna göre yapın.
...
DS-160 için önemli ipuçları:

- Her soruyu dürüstçe ve tutarlı bir şekilde cevaplayın.
- ABD gereksinimlerini karşılayan bir fotoğraf yükleyin (2x2 inç, beyaz arka plan, son 6 ay içinde çekilmiş).
- Onay sayfanızı kaydedin — mülakatınız için barkod numarasına ihtiyacınız olacak.
...
Konsolosluk mülakatı genellikle 2-5 dakika sürer. Memurun temel endişesi, ziyaretinizden sonra sizi geri dönmeye zorlayacak Türkiye'ye güçlü bağlarınız olup olmadığıdır. Şunları açıkça ifade etmeye hazırlanın:

- Seyahatinizin amacı
- Seyahat tarihleriniz
- Nerede kalacağınız
- Geziyi kimin finanse ettiği
- İstihdam durumunuz ve Türkiye'ye bağlarınız
...
Konsolosluk memuru tüm belgeleri görmek istemeyebilir ancak şunları getirmelisiniz:

1. **DS-160 onay sayfası**
2. **Pasaport** (geçerli ve eski pasaportlar)
3. **Mülakat randevu mektubu**
4. **MRV ücreti makbuzu**
5. **Güncel fotoğraf** (2x2 inç)
6. **Mali kanıt:** Banka hesap özetleri, vergi beyannameleri
7. **İşveren doğrulama mektubu**
8. **Mülk sahipliği belgeleri** ve aile bağları belgeleri
9. **Seyahat planınız** (otel, uçak bileti vb.)
...
- "Kimi ziyaret edeceksiniz?"
- "İşiniz ne?"
- "Daha önce uluslararası seyahat ettiniz mi?"
- "Geziyi kim ödüyor?"
- "ABD'de aileniz var mı?"

## INA 214(b) Kapsamında Ret ⚖️

Göç ve Vatandaşlık Yasası'nın 214(b) bölümü, her B vizesi başvuru sahibinin aksini kanıtlayana kadar göçmek niyetinde olduğunu varsayar. Bu, vize reddi için en yaygın nedendir.

Reddedilirseniz, ret nedenini açıklayan bir mektup alırsınız. İstediğiniz zaman yeniden başvurabilirsiniz, ancak ret nedenlerini ele almalısınız — tipik olarak memleketinize daha güçlü bağ kanıtları sunarak.
...
Başvuru süreci resmi UKVI portalında online olarak başlar. Bir hesap oluşturmanız, başvuru formunu doldurmanız ve vize ücretini ödemeniz gerekir (standart 6 aylık vize için şu anda **£115**).

Online form kişisel bilgilerinizi, seyahat geçmişinizi, mali durumunuzu ve ziyaret amacınızı kapsar. Online formu tamamladıktan sonra, Türkiye'deki bir Vize Başvuru Merkezi'nde (VAC) biyometrik randevu alırsınız.

VFS Global İstanbul, Ankara, İzmir ve diğer büyük şehirlerdeki VAC'ları işletmektedir.
...
- Geçerli pasaport
- Mali kanıt (son 6 aydaki banka hesap özetleri)
- İstihdam veya iş belgeleri
- Konaklama detayları
- Uçuş rezervasyonları
- Ziyaretinizi açıklayan bir niyet mektubu

Aile veya arkadaş ziyaret ediyorsanız, göç durumu detayları ile birlikte davet mektubu dahil edin.
...
Standart işlem **3-6 hafta** sürer. Ek ücret karşılığında öncelikli hizmetler mevcuttur:

- **Öncelik (5 iş günü):** £250
- **Süper Öncelik (ertesi iş günü):** £500

Planlanan seyahatinizden en az **8 hafta önce** başvurmanızı öneriyoruz.`,
  ...
  "rejection-reasons": {
    ...
    toc: [
      ...
      "Sebep 5: Önceki İhlaller",
      "Sebep 6: Yetersiz Sigorta",
...
Bu dünya çapında vize reddi için bir numaralı nedendir. Konsolosluklar, gezinizi mali zorluk yaşamadan rahatça karşılayabileceğinizi görmek ister.

**Çözüm:** Düzenli gelir gösteren 3-6 aylık banka hesap özetleri sunun, Schengen için günde en az €50-100 tutarını kapsayan bakiye tutun ve başvurmadan önce büyük açıklanmamış yatırımlar yapmaktan kaçının.

## Sebep 2: Ülkeye Zayıf Bağlar 🏠

Göç memurları ziyaretinizden sonra ülkenize döneceğinize inanmalıdır.

**Çözüm:** İş sözleşmeleri veya işletme sahipliği belgeleri, tapu veya uzun vadeli kira sözleşmeleri, aile belgeleri (evlilik cüzdanı, çocukların okul kaydı) ve memleketinizdeki devam eden taahhütlerin diğer kanıtlarını sunun.

## Sebep 3: Eksik Belgeler 📋

Tek bir gerekli belgenin eksik olması bile reddedilmeye neden olabilir.

**Çözüm:** Ayrıntılı bir belge kontrol listesi kullanın (VisaPath'in sunduğu gibi), gerekiyorsa tüm belgelerin uygun şekilde tercüme edildiğinden emin olun, her şeyin kopyasını çıkarın ve belgeleri konsolosluğun beklediği sırayla düzenleyin.

## Sebep 4: Tutarsız Bilgiler 🔍

Başvuru formunuz ile destekleyici belgeleriniz arasındaki tutarsızlıklar şüphe uyandırır.

**Çözüm:** Her belgedeki tüm tarihleri, tutarları ve ayrıntıları çapraz kontrol edin. Belirtilen seyahat amacınızın güzergahınız, konaklama ve mali düzenlemelerinizle eşleştiğinden emin olun.

## Sebep 5: Önceki Göç İhlalleri 🚫

Önceki bir vizeyi aşmak veya vize koşullarını ihlal etmek çok ciddiye alınır.

**Çözüm:** Geçmiş ihlalleriniz varsa, bunları başvurunuzda dürüstçe ele alın. Değişen koşulların kanıtını sunun ve artık ülkenize daha güçlü bağlarınız olduğunu gösterin.

## Sebep 6: Yetersiz Seyahat Sigortası 🏥

Birçok ülke belirli minimum kapsam gerektirir. Schengen vizeleri için sigorta, tıbbi harcamalarda ve geri dönüşte en az **€30.000**'u kapsamalıdır.

**Çözüm:** Hedef ülkenizin özel gereksinimlerini karşılayan tanınmış bir sağlayıcıdan kapsamlı seyahat sigortası satın alın.

## Sebep 7: Zayıf Mülakat Performansı 🎤

Mülakat gerektiren ülkelerde (ABD gibi), performansınız belgeleriniz kadar önemlidir.

**Çözüm:** Cevaplarınızı prova edin, kısa ve kendinden emin olun, profesyonel giyinin ve asla yalan söylemeyin veya abartmayın. Heyecanlanıyorsanız, VisaPath'in VIP Concierge planında sunulan profesyonel mülakat hazırlık hizmetlerini düşünün.`,
...
## Arka Plan Gereksinimleri 🖼️

Arka plan çoğu ülke için düz beyaz veya kırık beyaz olmalıdır.

- **ABD:** Düz beyaz arka plan gerektirir.
- **Schengen ülkeleri:** Açık gri veya açık mavi kabul eder.
- **İngiltere:** Düz krem veya açık gri arka plan gerektirir.

Desenli arka planlardan, arka plandaki gölgelerden veya saçınız veya kıyafetinizle karışan arka planlardan kaçının.

## Yüz İfadesi ve Poz 😐

Yüz ifadeniz nötr olmalı, ağzınız kapalı. Gülümseme, kaş çatma veya kaş kaldırma yok. Doğrudan kameraya bakın, her iki göz açık ve net görünür. Başınız ortada ve eğik olmamalıdır.

Tıbbi olarak gerekli olmadıkça gözlükleri çıkarın (bazı ülkeler gözlüklü fotoğrafları artık hiç kabul etmiyor). Baş örtüleri yalnızca dini amaçlarla kabul edilir ve yüzünüz yine de tamamen görünür olmalıdır.
...
En sık karşılaşılan fotoğraf ret nedenleri:

- Yanlış boyutlar
- Kırmızı göz
- Yüzde veya arka planda gölgeler
- Çok karanlık veya aşırı pozlanmış fotoğraf
- Gözlük takma (giderek daha çok reddediliyor)
- Yüzü kapatan baş örtüsü
- Yanlış arka plan rengi
- 6 aydan eski fotoğraf
- Dijital düzenleme veya filtreler

Her zaman hedefiniz için vize gereksinimlerini anlayan profesyonel bir fotoğraf hizmeti kullanın.`,
  ...
  "cover-letter": {
    ...
    content: `## Niyet Mektubu Neden Önemli ✉️
...
Niyet mektubunuz açık, profesyonel bir yapı izlemelidir:

1. Kişisel bilgileriniz ve başvurduğunuz vize ile başlayın.
2. Seyahat amacınızı belirtin.
3. Güzergahınız hakkında ayrıntılar verin.
4. Mali durumunuzu açıklayın.
5. Memleketinize bağlarınızı vurgulayın.
6. Kibarca vize onayı talebiyle kapatın.
...
- Tam adınız ve pasaport numaranız
- Başvurduğunuz özel vize türü ve süresi
- Tarihlerle birlikte ayrıntılı seyahat güzergahınız
- Kimi ziyaret ettiğiniz veya nerede kalacağınız
- Geziyi nasıl finanse ettiğiniz
- İstihdam durumunuz
- Memleketinizdeki aile bağları
- Vizenin süresi dolmadan dönme taahhüdünüz

## Nelerden Kaçınılmalı ❌

- Yanlış bilgi
- Servetiniz hakkında abartılı iddialar
- Duygusal yalvarışlar
- Alakasız kişisel hikayeler
- Memleketinize yönelik eleştiriler
- Vizenin izin verdiğinin ötesinde çalışma, eğitim veya kalışınızı uzatma niyetinden bahsetme
- Gerçek durumunuzu yansıtmayan genel şablonlar
...
- **🇵🇹 Portekiz (D8):** En popüler seçeneklerden. Aylık yaklaşık €3.040 gelir şartı var. 5 yıl sonra vatandaşlık yolu açık.
- **🇪🇸 İspanya:** Yeni başlayan program. Aylık yaklaşık €2.500 gelir gerektiriyor. Vergi avantajları mevcut.
    ...
    return (
      <div className="min-h-screen pt-24 pb-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/learn">
            <Button variant="outline">Bilgi Bankası'na Dön</Button>
          </Link>
        </div>
      </div>
    );
            ...
            >
              ...
              <div className="mt-12 p-8 md:p-10 rounded-2xl bg-gradient-navy text-primary-foreground">
                <h3 className="font-extrabold text-xl mb-3">
                  Başvurmaya hazır mısınız? Evrak işlerini bize bırakın.
                </h3>
                <p className="text-base opacity-70 mb-5">
                  VisaPath uzmanları vize başvurunuzun her adımında size
                  rehberlik edecek.
                </p>
                <Link to="/apply">
